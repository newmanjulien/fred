...
export const RENEWALS_TABLE_COLUMN_CLASS =
	'grid-cols-[minmax(10rem,1.45fr)_minmax(7.5rem,0.75fr)_minmax(7.75rem,0.8fr)_minmax(9rem,0.95fr)_minmax(8rem,0.85fr)_minmax(8.5rem,0.95fr)] md:grid-cols-[minmax(10rem,1.5fr)_minmax(8rem,0.75fr)_minmax(8.5rem,0.85fr)_minmax(10rem,1fr)_minmax(8.5rem,0.9fr)_minmax(9rem,1fr)]';

export const RENEWALS_TABLE_COLUMN_CLASS_WITH_SELECTION =
	'grid-cols-[var(--dashboard-table-selection-column-width)_minmax(10rem,1.45fr)_minmax(7.5rem,0.75fr)_minmax(7.75rem,0.8fr)_minmax(9rem,0.95fr)_minmax(8rem,0.85fr)_minmax(8.5rem,0.95fr)] md:grid-cols-[var(--dashboard-table-selection-column-width)_minmax(10rem,1.5fr)_minmax(8rem,0.75fr)_minmax(8.5rem,0.85fr)_minmax(10rem,1fr)_minmax(8.5rem,0.9fr)_minmax(9rem,1fr)]';
...
export const RENEWALS_TABLE_MIN_WIDTH_CLASS = 'min-w-[55rem] md:min-w-full';
